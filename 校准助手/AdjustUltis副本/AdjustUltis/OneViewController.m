...
- (void)configUI
{
   ...
   [_scrollV addSubview:firstBtn1];
    ...
    reviseBtn.frame = CGRectMake(30,777,60,60);
    reviseBtn.backgroundColor = [UIColor whiteColor];
    reviseBtn.layer.cornerRadius =30;
    ...
    thirdBtn2.frame = CGRectMake(110,777,60,60);
    thirdBtn2.backgroundColor = [UIColor whiteColor];
    thirdBtn2.layer.cornerRadius =30;
    ...
    reviseBtn1.frame = CGRectMake(210,777,60,60);
    reviseBtn1.backgroundColor = [UIColor whiteColor];
    reviseBtn1.layer.cornerRadius =30;
    ...
    thirdBtn3.frame = CGRectMake(290,777,60,60);
    thirdBtn3.backgroundColor = [UIColor whiteColor];
    thirdBtn3.layer.cornerRadius =30;
...
- (void)thirdBtn1Click
{
    ...
    if ([firstBtn1.titleLabel.text isEqualToString:@"单板调试"]) {
...
- (void)thirdBtn2Click
{
    ...
    if ([xBtn.backgroundColor isEqual:[UIColor greenColor]]) {
        [self sendDataWithIndex:1 andCount:1 andReviseIndex:2];
    }
    else if ([yBtn.backgroundColor isEqual:[UIColor redColor]])
    {
        [self sendDataWithIndex:2 andCount:1 andReviseIndex:2];
    }
    else if ([zBtn.backgroundColor isEqual:[UIColor yellowColor]])
    {
       [self sendDataWithIndex:3 andCount:1 andReviseIndex:2];
    }else if ([rBtn.backgroundColor isEqual:[UIColor purpleColor]])
    {
         [self sendDataWithIndex:7 andCount:1 andReviseIndex:2];
    }
}
...
- (void)thirdBtn3Click
{
    ...
    if ([xBtn.backgroundColor isEqual:[UIColor magentaColor]]) {
        [self sendDataWithIndex:4 andCount:2 andReviseIndex:2];
    }
    else if ([yBtn.backgroundColor isEqual:[UIColor orangeColor]])
    {
        [self sendDataWithIndex:5 andCount:2 andReviseIndex:2];
    }
    else if ([zBtn.backgroundColor isEqual:[UIColor cyanColor]])
    {
        [self sendDataWithIndex:6 andCount:2 andReviseIndex:2];
    }
    else if ([rbtn.backgroundColor isEqual:[UIColor blueColor]])
    {
        [self sendDataWithIndex:8 andCount:2 andReviseIndex:2];
    }
}
...
- (void)reviseBtn1Click
{
    ...
    yBtn.backgroundColor = [UIColor whiteColor];
    zBtn.backgroundColor = [UIColor whiteColor];
    rBtn.backgroundColor = [UIColor blueColor];
...
- (void)sendDataWithIndex:(NSInteger)index andCount:(NSInteger)count andReviseIndex:(NSInteger)reviseIndex
{
    if (count == 1)
    {
        ...
        [self.discoverPeripheral writeValue:[NSData dataWithBytes:byte length:10] forCharacteristic:self.characteristic type:CBCharacteristicWriteWithResponse];
...
- (void)fourthBtnClick
{
    ...
    [self.discoverPeripheral writeValue:data forCharacteristic:self.characteristic type:CBCharacteristicWriteWithResponse];
    NSLog(@"存储电机零位校准 %@",data);
}
