...
- (void)configUI
{
    ...
    btn.frame = CGRectMake((375-180)/2,450, 180, 60);
...
- (void)loadAnimation
{
    _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(225/2,100,150,300)];
...
{
    ConnectBLTViewController *bleVC = [ConnectBLTViewController new];
